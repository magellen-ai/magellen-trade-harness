"""Optional local intent log (ledger fills/orders remain source of truth)."""
...
from .paths import find_instance_root
...
class AuditLog:
    ...
    def write_event(
        ...
        entry = {
            ...
            "dry_run": dry_run,
            "order_id": order_id,
            "account": order_response.get("account", {}).get("account")
            if isinstance(order_response.get("account"), dict)
            else None,
        }
